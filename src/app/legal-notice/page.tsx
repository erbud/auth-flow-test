...
export default function LegalNoticePage() {
  return (
    <div className="p-4">
      ...
      <p>
        Àlex Royo Flaquer, responsable del sitio web, en adelante RESPONSABLE, pone a disposición de los usuarios el presente documento, con el que pretende dar cumplimiento a las obligaciones dispuestas en la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y de Comercio Electrónico (LSSICE), BOE N.º 166, así como informar a todos los usuarios del sitio web respecto a cuáles son las condiciones de uso.
      </p>
      <p>
        Toda persona que acceda a este sitio web asume el papel de usuario, comprometiéndose a la observancia y cumplimiento riguroso de las disposiciones aquí dispuestas, así como a cualquier otra disposición legal que fuera de aplicación.
      </p>
      <p>
        El RESPONSABLE se reserva el derecho de modificar cualquier tipo de información que pudiera aparecer en el sitio web, sin que exista obligación de preavisar o poner en conocimiento de los usuarios dichas obligaciones, entendiéndose como suficiente la publicación en el sitio web DECOMPETI.COM.
      </p>
      <h3>01. Datos identificativos</h3>
      <ul>
        <li>
          Nombre de dominio: decompeti.com
        </li>
        <li>
          Domicilio social: C/ JOAN MARAGALL 26, 5º4ª, 08191 RUBÍ (BARCELONA)
        </li>
        <li>
          E–mail: decompeti [punto] app [arroba] gmail [punto] com
        </li>
      </ul>
      <h3>02. Derechos de propiedad intelectual e industrial</h3>
      <p>
      ...
      <p>
        Para realizar cualquier tipo de observación respecto a posibles incumplimientos de los derechos de propiedad intelectual o industrial, así como sobre cualquiera de los contenidos del sitio web, puede hacerlo a través del correo electrónico decompeti [punto] app [arroba] gmail [punto] com.
      </p>
      <h3>03. Exención de responsabilidades</h3>
      <p>
      ...
      <h3>04. Ley aplicable y jurisdicción</h3>
      <p>
